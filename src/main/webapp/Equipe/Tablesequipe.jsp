...
<%
    List<ClassementGeneraleEquipe> equipe = (List<ClassementGeneraleEquipe>) request.getAttribute("classementequipe");
%>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table ">
                            ...
                            <tbody>
                            <% for( ClassementGeneraleEquipe u : equipe){ %>


                            <tr>
                                <td> <%= u.getEquipe().getNom()%></td>
                                <td> <%= u.getPointequipe()%></td>
                            </tr>
                            <%}%>
                            </tbody>
                        </table>
