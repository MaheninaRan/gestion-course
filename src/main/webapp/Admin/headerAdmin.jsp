            ...
            <div class="inner">
                <div class="row">
                        ...
                        <div class="main-menu">
                            <nav class="navigation">
                                <ul class="nav menu">
                                    ...
                                    <li><a href="#">Options <i class="icofont-rounded-down"></i></a>
                                        <ul class="dropdown">
                                            <li><a href="${pageContext.request.contextPath}/lien/finition">Down</a></li>
                                        </ul>
                                    </li>
                    ...
                    <div class="col-lg-2 col-12">
                        <div class="get-quote">
                            <a href="${pageContext.request.contextPath}/lag/deconnexion" class="btn">Deconnexion</a>
                        </div>
                    </div>
                </div>
            </div>
